 ...
 * full \r\n for all clients to work around this. Probably not needed these
 * days, but it might crop up one day if you ever did undefine it - there's
 * always someone out there :)
 */
#define BLOODY_IRCII_KLUGE
 ...
 */
# define MAX_OUTQUEUE_DUMP_SIZE		8192


/* This is the mask used when a channel is set +a (anonymous). Change this
 * only if you really need to, since the RFC says it should be set to this.
 */
# define ANONYMOUS_CHANNEL_MASK		"anonymous!anonymous@anonymous"
 ...
 * 
 * This could be dangerous, use with caution, or until it is safe :)
 */
//# define DROP_BRAINDEAD_SERVERS
