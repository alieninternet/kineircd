...
class ServerNotice {
 public:
   ...
   static servnotice_t const SN_KILL		= 0x00000100; // +k
   static servnotice_t const SN_LOCOPS		= 0x00000200; // +L
   static servnotice_t const SN_OPERING_LOCAL	= 0x00000400; // +o
   static servnotice_t const SN_OPERING_GLOBAL	= 0x00000800; // +O
   static servnotice_t const SN_SIGNON		= 0x00001000; // +s
   static servnotice_t const SN_SIGNOFF		= 0x00002000; // +S
   static servnotice_t const SN_SERVER		= 0x00004000; // +z
